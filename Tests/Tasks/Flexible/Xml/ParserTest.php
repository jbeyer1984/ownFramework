...
TXT;
    ...
    public function testRecursiveArray_Parser_success()
    {
        ...
        $dump = print_r($this->parser->getXmlArray(), true);
        error_log(PHP_EOL . '-$- in ' . basename(__FILE__) . ':' . __LINE__ . ' in ' . __METHOD__ . PHP_EOL . '*** $this->parser->getXmlArray() ***' . PHP_EOL . " = " . $dump . PHP_EOL);
